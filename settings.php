		...
		if ($_REQUEST['password1']!='' or $_REQUEST['password2']!=''){
			if ($_REQUEST['password1']!='' and $_REQUEST['password1']!=''){
					...
					if (preg_match($regexp["password"], $password1)){
						...
						$message=$message.'<p class="error">Ошибка:неправильный пароль.Необходимо минимум 8 символов, где одна строчная и одна заглавная буква и одна цифра и один спец символ (%,$,#,@,&,*,,^,|,/,~,{,},[,],\)</p>';
					}
			} else {
